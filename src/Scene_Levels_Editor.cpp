...
Scene_Levels_Editor::Scene_Levels_Editor(GameEngine* gameEngine)
    : Scene(gameEngine)
{
    init();
}

void Scene_Levels_Editor::init()
{
...
void Scene_Levels_Editor::update()
{
    m_entityManager.update();
}

void Scene_Levels_Editor::sDoAction(const Action& action)
{
...
void Scene_Levels_Editor::sRender()
{
...
void Scene_Levels_Editor::onEnd()
{
